...
function func_usage(){
    echo "$SCRIPT_NAME <HDFS_SRV_NAME> <PRIMARY_NAMENODE_SRV_NAME> <SECONDARY_NAMENODE_SRV_NAME>"    
    exit
}
...
DOCKER_COMPOSE_FILES=( "${DOCKER_COMPOSE_CONSUL_AGENT}" "${DOCKER_COMPOSE_HDFS_DATANODE}" )
